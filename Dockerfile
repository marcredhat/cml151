...
ENV PYTHON3_VERSION=3.9.11 \
    ML_RUNTIME_KERNEL="Python 3.9"

ADD build/python-3.9.11-pkg.tar.gz /usr/local

COPY etc/sitecustomize.py /usr/local/lib/python3.9/site-packages/
...
ENV ML_RUNTIME_EDITOR="PBJ Workbench" \
    ML_RUNTIME_EDITION="Marc Cuda 12.0" \
